...
def initialize_clip(config, num_patches=240):
    ...
    if config["clip_name"] == "ViT-B-16":
        ...
        #clip_model, preprocess = clip.load("C:/mPLUG/models/clip/ViT-B-16.tar", jit=False)
        
        clip_model, preprocess = clip.load(r"/gdata/Alamgir/mPLUG/models/clip/ViT-B-16.tar", jit=False)
        ...
        #clip_model, preprocess = clip.load(r"C:/mPLUG/models/clip/ViT-L-14.tar", jit=False)
        clip_model, preprocess = clip.load(r"/gdata/Alamgir/mPLUG/models/clip/ViT-L-14.tar", jit=False)
